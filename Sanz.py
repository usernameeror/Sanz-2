...
def yo_ndak_tau_ko_tanya_saia():
    ...
    if _asu_ == '':
        ...
        print('%s \x1b[1;92m║'%(O))
        jalan('\x1b[1;93m %s╠══%sMasuk Google chrome/google biasa lalu cari   %s╠══%s%sMY USER AGENT%s \x1b[1;93mlalu copy semua user agent anda...'%(O,N,O,N,H,N));time.sleep(2);os.system('')
