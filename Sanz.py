...
def tokenz():
	...
	try:
		...
		print(" \x1b[1;92m[\x1b[1;93m+\x1b[1;92m] \x1b[1;93mIP         \x1b[1;93m: %s"%(IP))       
                print(" \x1b[1;92m[\x1b[1;93m+\x1b[1;92m] \x1b[1;93m══════════════════════════════════════")               
                print(" \x1b[1;92m[\x1b[1;93m+\x1b[1;92m] \x1b[1;93m-------------------------------------------------------")
                print '\n%s \x1b[1;93m>%s  usahakan akun tumbal login di google chrome terlebih dahulu'%(B,N)
                print '%s \x1b[1;93m>%s jangan lupa! url ubah ke %shttps://m.facebook.com'%(B,N,H)
                print '%s \x1b[1;93m>%s setelah di alihkan ke google chrome. klik %stitik tiga'%(B,N,H)
                print '%s \x1b[1;93m>%s lalu klik %sCari di Halaman%s Tinggal ketik %sEAAA%s Lalu salin.'%(B,N,H,N,H,N)
